...
- luôn tối ưu SEO (Meta tags, Open Graph, Semantic HTML)

- luôn tối ưu accessibility (ARIA attributes, keyboard navigation, contrast)

- không tạo CSS trùng lặp, tận dụng style system sẵn có

- không dùng thư viện ngoài (dùng HTML/CSS/JS thuần)

- luôn giải thích ngắn gọn sau khi hoàn thành
...
tiếp tục sửa cho đến khi build thành công.
